      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <button className="px-6 py-2 rounded-full bg-gray-800 text-gray-300 hover:bg-gray-700 transition">
              Dashboard
            </button>
            <button className="px-6 py-2 rounded-full bg-orange-500 text-white hover:bg-orange-600 transition">
              Profile
            </button>
            <button className="px-4 py-2 rounded-lg bg-gray-800 text-red-500 hover:bg-gray-700 flex items-center gap-2 transition">
              <LogOut size={18} />
              Logout
            </button>
          </div>
