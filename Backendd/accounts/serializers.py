...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    def get_hostel(self, obj):
        if obj.hostel:
            return {'id': obj.hostel.id, 'name': obj.hostel.name}
        return None
    
    class Meta:
        model = CustomUser
        fields = ['first_name', 'last_name', 'email', 'user_type',
                  'roll_number', 'phone_number', 'profile_photo',
                  'hostel', 'student_profile', 'worker_profile']
...
class HostelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {'warden': {'required': False}}
